...
### Методика измерения
Для измерения необходимых значений использовался профилировщик [tracy](https://github.com/wolfpld/tracy). Выбор в его пользу был сделан из-за низкого влияния на производительность и возможности инструментирования кода. Измерениям подвергался цикл из `10^7` операций поиска в таблице. 
