...
3) Применение аттрибута `inline` к некоторым функциям
...
- **Ускорение относительно предыдущей оптимизации:** `1.00`

Как видно из результатов теста, одно лишь добавление флага оптимизации `-O3` позволило ускорить работу программы более чем в 2 раза.
